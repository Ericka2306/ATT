# Documentation du projet ATT

| Fichier | Rôle |
|---|---|
| `01_REGLES_DE_DEVELOPPEMENT.md` | Règles impératives, pile technique, architecture, conventions de code, permissions, méthode, protocole IA |
...
| `references/02_Instructions_Claude_Code_ATT.md` | Texte des instructions Claude Code (source : `.docx` dans le même dossier) |
| `references/SYNTHESE_COURS_M1.md` | Ce que le module enseigne séance par séance, ce qu'il n'enseigne pas, protocole IA |
