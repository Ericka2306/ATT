...
const AUTEURS = ["MAMINIAINA Ericka Fitiavana ETU001965", "ONINIAINA Mahery Harentsoa Arthur ETU002446"];
...
function architecture() {
  return [
    ...
    ...paras("L'annexe A montre ces briques dans le code, séance par séance : une règle pure et son test (A.1), une écriture lancée en coroutine (A.2), un ViewModel qui combine les flux de Room en un seul état (A.6), une écriture et sa ligne d'historique dans une même transaction (A.7)."),
    titre2("7.4 Sécurité"),
    ...puces(
...
function coursAppliques() {
  return [
    ...
    ...paras("Le code correspondant est reproduit en annexe A, séance par séance, tel qu'il apparaît dans l'éditeur."),
    ...puces(
...
function annexes() {
  return [
    titre1("Annexe A — Le code des cours, séance par séance"),
    ...paras("Cette annexe reprend le chapitre 12 avec le code sous les yeux : pour chaque séance du module, les lignes du projet où la notion du cours est appliquée, telles qu'elles apparaissent dans l'éditeur d'Android Studio, avec leurs numéros de ligne. Les pointillés marquent une partie repliée."),
    titre2("A.1 Séance 1 — Kotlin essentiel"),
    ...paras("Le tirage du sujet : val et var, filter puis shuffled sur une liste, une boucle for qui s'arrête au bon moment. Aucun !! : la fonction reçoit des valeurs et renvoie une liste."),
    imageCode("code_S1a.png"),
    ...paras("Une règle d'ouverture écrite avec when, sans if imbriqués : elle renvoie un message ou null (String?), et le compilateur oblige l'appelant à traiter le null."),
    imageCode("code_S1b.png"),
    ...paras("Son test JUnit : la fonction est pure, le test tourne sans téléphone ni base."),
    imageCode("code_S1c.png"),
    titre2("A.2 Séance 2 — Coroutines"),
    ...paras("Le faux serveur attend 600 ms par delay dans une fonction suspend : le fil d'exécution de l'interface n'est jamais bloqué, l'écran reste réactif pendant la synchronisation."),
    imageCode("code_S2a.png"),
    ...paras("Toute écriture part d'un viewModelScope.launch : les lectures suspend s'enchaînent, la règle métier tranche, et l'erreur éventuelle remonte dans l'état de l'écran."),
    imageCode("code_S2b.png"),
    titre2("A.3 Séance 3 — Anatomie Android"),
    ...paras("Une seule Activity, comme dans les projets du cours : elle pose le thème et confie tout le reste à la navigation. L'état des écrans vit dans les ViewModels et survit à la rotation."),
    imageCode("code_S3.png"),
    titre2("A.4 Séance 4 — Jetpack Compose"),
    ...paras("Un composable réutilisé par tous les formulaires : l'ouverture du menu est le seul état local (remember), le choix remonte au ViewModel par la lambda onChoix. L'interface est une fonction de l'état qu'elle reçoit."),
    imageCode("code_S4.png"),
    titre2("A.5 Séance 5 — Navigation Compose"),
    ...paras("Des routes en chaînes de caractères, l'identifiant en argument."),
    imageCode("code_S5a.png"),
    ...paras("À l'arrivée sur une route, l'identifiant est relu par idArgument (toIntOrNull, jamais de plantage) ; l'écran reçoit des lambdas (onRetour) et ne connaît pas le navController."),
    imageCode("code_S5b.png"),
    titre2("A.6 Séance 6 — Architecture MVVM"),
    ...paras("Un ViewModel du cours : ses MutableStateFlow restent privés, l'écran ne reçoit qu'un StateFlow d'état immuable, construit par combine sur les flux de Room et gardé par stateIn tant qu'un écran l'observe."),
    imageCode("code_S6.png"),
    titre2("A.7 Séance 7 — Room et hors ligne d'abord"),
    ...paras("Une entité Room avec ses clés étrangères et ses index, et le drapeau synchronisee de la démonstration de synchronisation vue en cours."),
    imageCode("code_S7a.png"),
    ...paras("Le DAO : la file d'attente est une requête, le compteur affiché est un Flow tenu à jour par Room, et le drapeau se lève par un UPDATE qui ne touche à rien d'autre."),
    imageCode("code_S7b.png"),
    ...paras("La boucle de synchronisation : elle remonte ce qui attend, dans l'ordre, et s'arrête au premier échec sans rien perdre. La base locale reste la source de vérité."),
    imageCode("code_S7c.png"),
    ...paras("Une écriture et sa ligne d'historique dans une même transaction : Room les écrit ensemble ou n'écrit rien, l'historique ne peut pas raconter autre chose que ce qui s'est passé."),
    imageCode("code_S7d.png"),
